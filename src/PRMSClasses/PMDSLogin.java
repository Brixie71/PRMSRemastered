...
public class PMDSLogin extends JFrame {
    ...
    private void PMDSLoginComponents(){
        ...
        exit.setFont(new Font("Quicksand", Font.PLAIN, 16));
        exit.setBorder(null);
    ...
    private void ExitButtonFunction(ActionEvent evt){
            ...
            int Question_YES  = JOptionPane.showConfirmDialog(null, "Do you want to close the Program?","BTS : PMDS - Confirmation",JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
            ...
            if (Question_YES==JOptionPane.YES_OPTION) {
                ...
                String title1 = "BTS : PMDS - Confirmation";
    ...
    public static void main(String[] args) {
        ...
        PMDSLogin Launch = new PMDSLogin();
